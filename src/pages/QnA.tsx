...
export function QnA() {
	...
	const onValid = (data:any) => {
		...
		send("post", "/api/inquiry/save", "application/x-www-form-urlencoded", data, function(r) {
			const result = r.data;
			if (result.data > 0) {
...
return (
	<BoxQna className="inner">
			<SectionTitle>
				...
				<p className="sub__title">견적 문의사항 남겨주시면<br/>담당자가 확인 후 친절하게 답변해 드리겠습니다.</p>
			</SectionTitle>
				...
				<ul className="list__form">
					<li className="list-item">
						...
						<div className="box__form-set">
							...
							<p className="text__error">{formState.errors?.company?.message}</p>
						</div>
					</li>
					<li className="list-item">
						<div className="box__title">
						...
						<div className="box__form-set">
							...
							<p className="text__error">{formState.errors?.industry?.message}</p>
						</div>
					</li>
					<li className="list-item">
						<div className="box__title">
					...
					<li className="list-item">
						...
						<div className="box__form-set">
							{workTypeList}
							<p className="text__error">{formState.errors?.workType?.message}</p>
						</div>
					...
					<li className="list-item">
						...
						<div className="box__form-set">
							...
							<p className="text__error">{formState.errors?.workLoad?.message}</p>
						</div>
						<p className="text__noti">- 일일 기준 응대콜 처리량, 게시판 처리량, 톡상담 처리량, 기타 처리량를 입력해주세요.</p>
					</li>
					<li className="list-item">
						<div className="box__title">

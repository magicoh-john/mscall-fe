...
import { FlexList, GridList, imgDataType, listDataType } from "../components/List";
...
function Home(){
    ...
    return(
        <>
            <MainVisual id="mainVis" image="./assets/image/image__main-vis.png" title="MS, Make Service" text="최상의 서비스, 최고의 파트너"/>
            <BoxSection className="inner">
                <Title className="scrollMotion"><strong>MS COMPANY</strong>는 이런 업무를 합니다.</Title>
            ...
            <BoxSection className="inner">
                <Title className="scrollMotion"><strong>MS COMPANY</strong>와 함께라면 ?</Title>
                <FlexList data={dummyData} class="scrollMotion"></FlexList>
            </BoxSection>
            <BoxSection>
                <Title className="scrollMotion"><strong>MS COMPANY</strong>가 비용절감에 도움을 드리겠습니다.</Title>

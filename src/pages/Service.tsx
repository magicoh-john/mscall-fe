...
export default function Service(){
    ...
    return(
        <>
            <SubVisual title="제공서비스" text="높은 퀄리티로 고객의 만족도를 높이는 MS COMPANY" image="./assets/image/image__sub-vis4.png"></SubVisual>
            <div className="inner">
                <BoxSection>
                    ...
                    <BoxStep>
                        {
                            stepData.map((item,idx)=>{
                                return(     
                                    <li className="list-item">
                                        <p className="box__icon"><img src={item.icon} alt="" /></p>
                                        <div className="box__text">
                                            <p className="text__title"><span className="text__step">STEP{idx+1}.</span>{item.title}</p>
                                            <p className="text">{item.text}</p>
                                        </div>
                                    </li>
                                )

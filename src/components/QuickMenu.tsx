...
export function QuickMenu(){
	...
	const openLayer = (event: React.FormEvent<HTMLButtonElement>)=>{
		...
		window.open("http://pf.kakao.com/_jMWSxj", '', 'width=400, height=600'); return false;
	}
	...
	return(
		<BoxQuick>
			...
			<button type="button" onClick={openLayer} className="button__quick button__kakao"><span className="for-a11y">톡상담</span></button>
